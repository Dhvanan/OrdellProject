...
<body>
	...
	<div class="container">
		...
		<div class="content">
			...
			<h3>English</h3>
			<div>
			<img src="GOT.jpg" id="video1Btn" onclick="loadVideo1('C:/TV SHOWS/S04E09.mp4','Aladdin')" value="Load Video 1" width="100"/>
			<br><br>
		...
		<div 
             class="footer">Copyright 2014-2024 by Bromigos
        </div>
